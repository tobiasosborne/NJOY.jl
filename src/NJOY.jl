...
# PostScript rendering engine (viewr graph engine -- matching Fortran graph.f90/viewr.f90)
include("viewr/constants.jl")
include("viewr/types.jl")
include("viewr/ps_primitives.jl")
include("viewr/transforms.jl")
include("viewr/text.jl")
include("viewr/symbols.jl")
include("viewr/axes.jl")
include("viewr/curves.jl")
include("viewr/plot_tape.jl")
include("viewr/set2d.jl")
include("viewr/viewr.jl")
...
include("processing/wimsr_xsecs.jl")
